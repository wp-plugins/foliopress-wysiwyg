...
$aFckOptions = get_option('fp_wysiwyg');

$image_path_changed = false;
if ($aFckOptions["image_path_changed"] || $aFckOptions["seo_images_reset"])
{
  $image_path_changed = true;
  $aFckOptions["image_path_changed"] = false;
  update_option('fp_wysiwyg',$aFckOptions);
}
/**
...
if( count( $kfm_special_thumbs_sizes ) <1 ) { //  failsafe
  $kfm_special_thumbs_sizes = array( 400, 200, 150 );
}
