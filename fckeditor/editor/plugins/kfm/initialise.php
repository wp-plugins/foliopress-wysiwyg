...
if (is_dir($workpath)) {
    ...
    if (is_writable(dirname($workpath_tmp)))mkdir($workpath_tmp, octdec( '0' . $kfm->setting('default_upload_permission') ) );
    else{
...
/// Addition  2010/06/30
if( isset( $aFckOptions["kfmlang"] ) && $aFckOptions["kfmlang"] != 'en' ) {
