...
1. Make sure you are able to open this link: <a href="#" onClick="return false">http://(enter-your-blog-address-here)/wp-content/plugins/foliopress-wysiwyg/custom-config/foliopress-wysiwyg-config-js.php</a> You should see a Foliopress WYSIWYG JavaScript config file. If you get a 404 page, make sure the /wp-content/plugins/foliopress-wysiwyg/custom-config/ directory has right access permissions (probably 755) and that the PHP scripts are executed correctly from there.
